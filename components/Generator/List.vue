    ...
    <div flex justify-center items-center h-auto my-12>
        <div flex-1 container space-y-10>
            ...
            <div flex items-center justify-center flex-col>
                ...
                <button @click="findNames()" mb-10 bg-white text-green-500 cursor-pointer px-10 py-2 rounded-md
                    border-none font-bold text-lg shadow-lg>
                    Find
                </button>
            ...
            -->
                    ...
                    <GeneratorResultName v-for="(sn, index) in selectedNames" :key="sn" :selectedNames="sn"
